...
class ProfileDetail(generics.RetrieveUpdateDestroyAPIView):
    ...
    # Make sure TokenAuthentication is listed
    authentication_classes = [SessionAuthentication, BasicAuthentication, TokenAuthentication]
    permission_classes = [IsAuthenticated]
    # lookup_field = 'pk' # Default, can be explicit

    # --- REMOVE THE OVERRIDDEN post, put, delete, patch methods ---

    # Optional: You can still override get if needed, but often not necessary
    # @swagger_auto_schema(tags=["Profile"])
